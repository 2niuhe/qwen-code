...
export function RadioButtonSelect<T>({
  ...
  useKeypress(
    (key) => {
      const inputChar = key.sequence;
      const isNumeric = showNumbers && /^[0-9]$/.test(inputChar);
      ...
      if (isNumeric) {
        ...
        const newNumberInput = numberInput + inputChar;
